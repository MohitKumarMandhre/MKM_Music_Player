...
music_player = tkr.Tk()
music_player.title("Life in MKM-Music-Player")
...
Button1 = tkr.Button(music_player, width=5, height=3, font="Helvetica 12 bold", text="PLAY",
 command=play, bg="blue", fg="white")
